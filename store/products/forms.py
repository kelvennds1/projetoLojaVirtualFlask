...
class Addprodutos(Form):
    ...
    image_1 = FileField('Image 1: ' , validators=[FileAllowed(['jpg', 'png', 'gif', 'jfif', 'jpeg'])])
    image_2 = FileField('Image 2: ' , validators=[FileAllowed(['jpg', 'png', 'gif', 'jfif', 'jpeg'])])
    image_3 = FileField('Image 3: ' , validators=[FileAllowed(['jpg', 'png', 'gif', 'jfif', 'jpeg'])])
